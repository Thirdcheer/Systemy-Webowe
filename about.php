...
<body class="about-page" onkeydown="getUnicode(event)" onclick="coords(event)">
    <header class="header">
    ...
    <div class="main-content">
        <hr>
        <div id="show_unicode"></div>
        <button id="createButton" onclick="aboutClickMe()">Pokaż obrazek</button>
        <div class="promotion">
            <hr>
